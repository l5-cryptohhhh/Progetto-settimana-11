...
import { Renderer, Camera, Mesh, Plane, Program, RenderTarget as OglRenderTarget, Texture } from 'ogl'
...
function deriveFontSettings(fallbackFamily: string, fallbackWeight: string | number, fallbackSizePx: number): FontSettings {
...
export default function DotMatrix({
  ...
  useEffect(() => {
    ...
    if (useGlyphAtlasFlag) {
      ...
      glyphGridRef.current = { cols: atlas.cols, rows: atlas.rows, count: atlas.count }
